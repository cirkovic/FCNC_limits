...
OUTPUTBR=${OUTDIR}/TrainingsWithTightEID_NEW_OBS_${CASE}_BR/${N}
OUTPUTcoup=${OUTDIR}/TrainingsWithTightEID_NEW_OBS_${CASE}_coup/${N}
...
#mkdir cards
#cp -f produce_cards/TrainingsWithTightEID_NEW_${CASE}_${N}_1_ttAdd_statBinUnc_corrected_StatUnc_2_01-07-2017/produceCards_${N}.C produceCards.C
#./produceCards.zsh
#cd cards
#sh ../make_combos_${N}_new.sh
#cd ..

#cp -r input_cards cards
cp -r cards_07-08-2017 cards
#cp -r input_cards_03-08-2017 cards
cd cards
# ...
cd ..
...
#./COMBINE_OBS_01-07-2017.sh ${N} ${S} ${CASE}
./COMBINE_OBS_07-08-2017.sh ${N} ${S} ${CASE}
#./COMBINE_OBS_03-08-2017.sh ${N} ${S} ${CASE}
#./COMBINE_OBS_07-08-2017.sh ${N} ${S} ${CASE}
...
#./runShow_wohutb4j4_obs.sh $OUTPUT 15.0 15.0 true
#./runShow_wohutb4j4_obs.sh $OUTPUTfalse 15.0 15.0 false
#./runShow_wohutb4j4_obs_27-07-2017.sh $OUTPUT 15.0 15.0 true
#./runShow_wohutb4j4_obs_27-07-2017.sh $OUTPUTfalse 15.0 15.0 false
#./runShow_wohutb4j4_obs_27-07-2017.sh $OUTPUT 17.0 17.0 true
#./runShow_wohutb4j4_obs_27-07-2017.sh $OUTPUTfalse 17.0 17.0 false
./runShow_wohutb4j4_obs_07-08-2017.sh $OUTPUT 17.0 17.0 0
./runShow_wohutb4j4_obs_07-08-2017.sh $OUTPUTBR 17.0 17.0 1
./runShow_wohutb4j4_obs_07-08-2017.sh $OUTPUTcoup 17.0 17.0 2
#./runShow_wohutb4j4_obs_07-08-2017.sh $OUTPUT 2300.0 2300.0 0
#./runShow_wohutb4j4_obs_07-08-2017.sh $OUTPUTBR 2300.0 2300.0 1
#./runShow_wohutb4j4_obs_07-08-2017.sh $OUTPUTcoup 2300.0 2300.0 2
fi
cd plot
...
./runShow_small_2_obs_07-08-2017.sh $OUTPUT 300.0 0.1 300.0 0.1 0
./runShow_small_2_obs_07-08-2017.sh $OUTPUTBR 300.0 0.1 300.0 0.1 1
./runShow_small_2_obs_07-08-2017.sh $OUTPUTcoup 300.0 0.1 300.0 0.1 2
#./runShow_small_2_obs_07-08-2017.sh $OUTPUT 10000.0 100 10000.0 100 0
#./runShow_small_2_obs_07-08-2017.sh $OUTPUTBR 10000.0 100 10000.0 100 1
#./runShow_small_2_obs_07-08-2017.sh $OUTPUTcoup 10000.0 100 10000.0 100 2
