...
OUTPUT=~/www/31-07-2017/WithStatUnc_mscan
OUTPUT=~/www/01-08-2017/WithStatUnc_mscan
OUTPUT=~/www/03-08-2017/WithStatUnc_mscan
OUTPUT=~/www/07-08-2017/WithStatUnc_mscan
OUTPUT=~/www/07-08-2017/WithStatUnc_mscan_positiveNegative
OUTPUT=~/www/08-08-2017/WithStatUnc_mscan_positiveNegative
...
#    for j in hdamp_UE_Jes_SfIterativeFit; do
    ...
    #./RUN_pulls_unblinded_WithStatUnc_mscan_01-08-2017.sh ${OUTPUT} ${i}
    #./RUN_pulls_unblinded_WithStatUnc_mscan_03-08-2017.sh ${OUTPUT} ${i}
    #./RUN_pulls_unblinded_WithStatUnc_mscan_07-08-2017.sh ${OUTPUT} ${i}
    ./RUN_pulls_unblinded_WithStatUnc_mscan_07-08-2017_positiveNegative.sh ${OUTPUT} ${i}
done
