...
OUTPUT=~/www/25-03-2017_STTT/TrainingsWithTightEID_NEW_EXP_${CASE}/ST
OUTPUT=${1}/TrainingsWithTightEID_NEW_EXP_${CASE}/ST
...
#./COMBINE_NEW_EXP_5_small_ST.sh ${N} ${S} ${CASE}
./COMBINE_NEW_EXP_5_small_ST_1.sh ${N} ${S} ${CASE}
...
./runShow_small.sh $OUTPUT 20.0 130.0
fi
cd plot
