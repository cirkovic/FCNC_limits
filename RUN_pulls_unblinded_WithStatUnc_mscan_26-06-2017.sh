...
cp -f produce_cards/TrainingsWithTightEID_NEW_${CASE}_combSTandTT_1_ttAdd_statBinUnc_corrected_StatUnc_2_26-06-2017/produceCards_${N}.C produceCards.C
