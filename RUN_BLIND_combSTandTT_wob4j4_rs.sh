...
OUTPUT=~/www/10-03-2017_wob4j4/TrainingsWithTightEID_NEW_BLIND_${CASE}/${N}
OUTPUT=~/www/15-03-2017/TrainingsWithTightEID_NEW_BLIND_${CASE}_wob4j4/${N}
OUTPUT=~/www/21-03-2017/limits/TrainingsWithTightEID_NEW_BLIND_${CASE}_wob4j4/${N}
OUTPUT=~/www/22-03-2017/limits/TrainingsWithTightEID_NEW_BLIND_${CASE}_wob4j4/${N}
OUTPUT=${OUTDIR}/TrainingsWithTightEID_NEW_BLIND_${CASE}_wob4j4/${N}
...
./COMBINE_NEW_BLIND_rs.sh ${N} ${S} ${CASE}
