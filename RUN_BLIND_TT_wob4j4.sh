...
OUTPUT=~/www/25-03-2017_STTT/TrainingsWithTightEID_NEW_BLIND_${CASE}_wob4j4/TT
OUTPUT=${1}/TrainingsWithTightEID_NEW_BLIND_${CASE}_wob4j4/TT
...
#./COMBINE_NEW_BLIND_5_small_TT.sh ${N} ${S} ${CASE}
./COMBINE_NEW_BLIND_5_small_TT_1.sh ${N} ${S} ${CASE}
...
./runShowWob4j4_small.sh $OUTPUT 10.0 10.0
fi
cd plot
