...
#./COMBINE_EXP_small.sh ${N} ${S} ${CASE}
#./COMBINE_EXP.sh ${N} ${S} ${CASE}
./COMBINE_EXP_1.sh ${N} ${S} ${CASE}
...
cp limits/limits.h limits/plot/limitsHut.h limits/plot/limitsHct.h limits/limitNums_Hut.txt limits/limitNums_Hct.txt backup_limits_expected_${CASE}_${DATE}
