...
OPTIONS1=""
OPTIONS1="$OPTIONS1 --rMin=-0.5 --rMax=051"
...
#    if [[ "$i" == *"b3j4_hct"* ]]; then
#        COMMAND="combine -S ${S} -M MaxLikelihoodFit ${OPTIONS1} --expectSignal 0.04 ../cards/${i} -n _1 --minos=all && python /afs/cern.ch/work/c/cirkovic/kLimits/CombineHarvester/CMSSW_7_4_7/src/HiggsAnalysis/CombinedLimit/test/diffNuisances_noMCstat.py -a mlfit_1.root -g plots_1.root"
#    fi
...
#    if [[ "$i" == *"b3j4_hct"* ]]; then
#        COMMAND="combine -S ${S} -M MaxLikelihoodFit ${OPTIONS1} --expectSignal 0.0 ../cards/${i} -n _0 --minos=all && python /afs/cern.ch/work/c/cirkovic/kLimits/CombineHarvester/CMSSW_7_4_7/src/HiggsAnalysis/CombinedLimit/test/diffNuisances_noMCstat.py -a mlfit_0.root -g plots_0.root"
#    fi
