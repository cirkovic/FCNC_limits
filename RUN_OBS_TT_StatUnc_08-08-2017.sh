...
./runShow_wohutb4j4_obs_STTT_08-08-2017.sh $OUTPUT 25.0 15.0 0 ${N}
./runShow_wohutb4j4_obs_STTT_08-08-2017.sh $OUTPUTBR 25.0 15.0 1 ${N}
./runShow_wohutb4j4_obs_STTT_08-08-2017.sh $OUTPUTcoup 25.0 15.0 2 ${N}
#fi
cd plot
