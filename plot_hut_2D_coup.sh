...
rm -f  COMBINE_OUTPUT_${N}_ALL_hut_${n}_${m}.txt;
...
#            FOLDER2=2D_${n}_${m}/LIMITS1/limits_${CASE}_${i}_${j}/${N}
            ...
            #FOLDER1=2D_hut_${n}_${m}/LIMITS/limits_${CASE}_${i}_${j}/${N}
            FOLDER1=2D_hut_${n}_${m}/limits_${CASE}_${i}_${j}/${N}
            echo CIRKOVIC ${i} ${j} >> COMBINE_OUTPUT_${N}_ALL_hut_${n}_${m}.txt
...
#            fi
            ...
            if [[ `ls ${FOLDER1}/COMBINE_OUTPUT_INPUT_MVAHuctComb_comb_huct_${N}_${CASE}_${i}_${j}.txt` != "" ]]; then
                cat ${FOLDER1}/COMBINE_OUTPUT_INPUT_MVAHuctComb_comb_huct_${N}_${CASE}_${i}_${j}.txt >> COMBINE_OUTPUT_${N}_ALL_hut_${n}_${m}.txt
#            elif [[ `ls ${FOLDER2}/COMBINE_OUTPUT_INPUT_MVAHuctComb_comb_huct_${N}_${CASE}_${i}_${j}.txt` != "" ]]; then
#                cat ${FOLDER2}/COMBINE_OUTPUT_INPUT_MVAHuctComb_comb_huct_${N}_${CASE}_${i}_${j}.txt >> COMBINE_OUTPUT_${N}_ALL_hut_${n}_${m}.txt
#            elif [[ `ls ${FOLDER3}/COMBINE_OUTPUT_INPUT_MVAHuctComb_comb_huct_${N}_${CASE}_${i}_${j}.txt` != "" ]]; then
#                cat ${FOLDER3}/COMBINE_OUTPUT_INPUT_MVAHuctComb_comb_huct_${N}_${CASE}_${i}_${j}.txt >> COMBINE_OUTPUT_${N}_ALL_hut_${n}_${m}.txt
            fi

            #cat ${FOLDER}/COMBINE_OUTPUT_INPUT_MVAHuctComb_comb_huct_${N}_${CASE}_${i}_${j}.txt >> COMBINE_OUTPUT_${N}_ALL_hut_${n}_${m}.txt
#        fi
        echo >> COMBINE_OUTPUT_${N}_ALL_hut_${n}_${m}.txt;
        echo >> COMBINE_OUTPUT_${N}_ALL_hut_${n}_${m}.txt;
        echo >> COMBINE_OUTPUT_${N}_ALL_hut_${n}_${m}.txt;
        :
    done
...
grep "CIRKOVIC \|Expected \|Observed " COMBINE_OUTPUT_${N}_ALL_hut_${n}_${m}.txt > COMBINE_OUTPUT_${N}_xALL.txt
mv COMBINE_OUTPUT_${N}_xALL.txt COMBINE_OUTPUT_${N}_ALL_hut_${n}_${m}.txt
