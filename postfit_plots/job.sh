...
#    COMMAND="text2workspace.py input_${category}.txt -o workspace_${category}.root ${OPTIONS}"
else
...
if [[ "${RMIN}" == "0" ]] && [[ "${RMAX}" == "0" ]] ; then
    ...
    COMMAND="combine input_${category}.txt -M MaxLikelihoodFit -m ${M} --saveShapes --saveOverallShapes --saveWithUncertainties --saveNormalizations --plots --robustFit 1 $OPTIONS"
    #COMMAND="combine workspace_${category}.root -M MaxLikelihoodFit --saveShapes --saveWithUncertainties --plots -v 3 -m ${M} -t -1 --expectSignal 1 -n _shapes_bkgsigAsimov --saveOverallShapes $OPTIONS"
    #COMMAND="combine workspace_${category}.root -M MaxLikelihoodFit --saveShapes --saveWithUncertainties --plots -v 3 -m ${M} -t -1 --expectSignal 1 --saveOverallShapes $OPTIONS"
#    COMMAND="combine workspace_${category}.root -M MaxLikelihoodFit --saveShapes --saveWithUncertainties --plots -v 3 -m ${M} -t -1 --expectSignal 1 $OPTIONS"
else
    ...
    COMMAND="combine input_${category}.txt -M MaxLikelihoodFit -m ${M} --saveShapes --saveOverallShapes --saveWithUncertainties --saveNormalizations --plots --robustFit 1 --rMin=${RMIN} --rMax=${RMAX} $OPTIONS"
    #COMMAND="combine workspace_${category}.root -M MaxLikelihoodFit --saveShapes --saveWithUncertainties --plots -v 3 -m ${M} -t -1 --expectSignal 1 -n _shapes_bkgsigAsimov --saveOverallShapes --rMin=${RMIN} --rMax=${RMAX} $OPTIONS"
    #COMMAND="combine workspace_${category}.root -M MaxLikelihoodFit --saveShapes --saveWithUncertainties --plots -v 3 -m ${M} -t -1 --expectSignal 1 --saveOverallShapes --rMin=${RMIN} --rMax=${RMAX} $OPTIONS"
#    COMMAND="combine workspace_${category}.root -M MaxLikelihoodFit --saveShapes --saveWithUncertainties --plots -v 3 -m ${M} -t -1 --expectSignal 1 --rMin=${RMIN} --rMax=${RMAX} $OPTIONS"
...
#COMMAND="PostFitShapesFromWorkspace -w workspace_${category}.root -o ${category}_shapes_postfit.root -m ${M} -f mlfit.root:fit_s --postfit --sampling --print"
echo $COMMAND
eval $COMMAND
echo
echo
