#OUTPUT=~/www/26-01-2017/1
OUTPUT=~/www/31-03-2017/1
...
for cat in MVAHutComb_b2j3_hut MVAHutComb_b2j4_hut MVAHutComb_b3j3_hut MVAHutComb_b3j4_hut MVAHutComb_b3j4_hut  MVAHctComb_b2j3_hct MVAHctComb_b2j4_hct MVAHctComb_b3j3_hct MVAHctComb_b3j4_hct MVAHctComb_b4j4_hct  MVAHutComb_comb_hut MVAHctComb_comb_hct; do
...
#    #PostFitShapesFromWorkspace -w input_${cat}.root -d input_${cat}.txt -o ${cat}_shapes_postfit.root -m 125 -f mlfit.root:fit_s --postfit --sampling --covariance --print
    ...
    ./../job_1.sh ${CMSSW_BASE} `pwd` ${cat} 2>&1 | tee OUTPUT.txt &
    PS="$PS $!"
