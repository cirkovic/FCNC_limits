...
for ci, (r, g, b) in enumerate([
    ...
    (229, 229, 102),  # 1013 FCNC kHct sig
]):
...
#                hcolors = [ 1011, 1010, 1012, kBlack ]
                ...
                hcolors = [ 1000, 1001, 1002, 1010, 1013, kBlack ]
...
#            fs.append(TFile.Open('MVAH'+hyp+'tMAX_'+cat+'_h'+hyp+'t_shapes_postfit.root'))
            ...
            print 'MVAH'+hyp+'tComb_'+cat+'_h'+hyp+'t_'+iteration+'_'+mass+'/'+'MVAH'+hyp+'tCmob_'+cat+'_h'+hyp+'t_shapes_postfit.root'
            #fs.append(TFile.Open('MVAH'+hyp+'tMAX_'+cat+'_h'+hyp+'t_'+iteration+'_'+mass+'/'+'MVAH'+hyp+'tMAX_'+cat+'_h'+hyp+'t_shapes_postfit.root'))
            fs.append(TFile.Open('MVAH'+hyp+'tComb_'+cat+'_h'+hyp+'t_'+iteration+'_'+mass+'/'+'MVAH'+hyp+'tComb_'+cat+'_h'+hyp+'t_shapes_postfit.root'))
            ...
            #for p in ['prefit']:
                ...
                for hi, h in enumerate(hnames):
                    ...
                    if h == 'data_obs':
                        ...
                        hsigs.append(hs[h].Clone())
                        hsigs[-1].SetFillStyle(0)
                        hsigs[-1].SetLineColor(hsigs[-1].GetFillColor())
                        hsigs[-1].SetLineWidth(3)
                        leg.AddEntry(hsigs[-1], h, "l")
                    else:
                        hss[-1].Add(hs[h])
...
#                hss[-1].GetXaxis().SetTitle('MVAH'+hyp+'t_'+cat)
                ...
                hss[-1].GetXaxis().SetTitle('MVAH'+hyp+'tComb_'+cat)
                ...
                hfin.Draw("E2 SAME")
                hd.Draw("P SAME")
                #hsigs[-2].Draw("HIST SAME")
                hsigs[-1].Draw("HIST SAME")
                leg.Draw()
