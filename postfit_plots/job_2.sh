...
COMMAND="combine input_${cat}.root -M MaxLikelihoodFit -m 125 --saveShapes --saveOverallShapes --saveWithUncertainties --saveNormalizations --plots --robustFit 1 --justFit"
echo $COMMAND
eval $COMMAND
echo
echo
