N=${1}
CASE=${2}
OUTPUT=~/www/01-03-2017_2/TrainingsWithTightEID_new_exp_${CASE}/${1}
OUTPUT=~/www/01-03-2017_4/TrainingsWithTightEID_new_exp_${CASE}/${1}
OUTPUT=~/www/02-03-2017_2/TrainingsWithTightEID_new_exp_${CASE}/${1}
...
./COMBINE_Closure_NEW_minosAll_exp.sh ${N} ${S}
