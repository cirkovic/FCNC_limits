...
#if [[ "${N}" == "combSTandTT" || "${N}" == "ST"  || "${N}" == "TT" ]]; then
if [[ "${N}" == "combSTandTT" ]]; then
    #cp -r input_cards cards
    #cp -r input_cards1 cards
    #cp -r input_cards_03-08-2017 cards
    cp -r cards_07-08-2017_${N} cards
    cd cards
    #...
    cd ..
else
...
#./COMBINE_pulls_OBS_unblinded_NEW_mscan_01-07-2017.sh ${N} ${S}
#./COMBINE_pulls_OBS_unblinded_NEW_mscan_01-08-2017.sh ${N} ${S}
#./COMBINE_pulls_OBS_unblinded_NEW_mscan_03-08-2017.sh ${N} ${S}
#./COMBINE_pulls_OBS_unblinded_NEW_mscan_07-08-2017.sh ${N} ${S}
./COMBINE_pulls_OBS_unblinded_NEW_mscan_07-08-2017_positiveNegative.sh ${N} ${S}
