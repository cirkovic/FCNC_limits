...
/*	     fc << "bin " << cat[ic] << " " << cat[ic] << std::endl;
         ...
         */
         fc << "SfIteraviveFitLf shape 1 1 1 1 0 0 0 0" << std::endl;
         fc << "SfIteraviveFitHf shape 1 1 1 1 0 0 0 0" << std::endl;
         fc << "SfIteraviveFitLfstats1 shape 1 1 1 1 0 0 0 0" << std::endl;
         fc << "SfIteraviveFitLfstats2 shape 1 1 1 1 0 0 0 0" << std::endl;
         fc << "SfIteraviveFitHfstats1 shape 1 1 1 1 0 0 0 0" << std::endl;
         fc << "SfIteraviveFitHfstats2    shape 1 1 1 1 0 0 0 0" << std::endl;
         fc << "SfIteraviveFitCferr1    shape 1 1 1 1 0 0 0 0" << std::endl;
         fc << "SfIteraviveFitCferr2    shape 1 1 1 1 0 0 0 0" << std::endl;
         fc << "SfPileup    shape 1 1 1 1 0 0 0 0" << std::endl;
         fc << "SfLepton shape 1 1 1 1 0 0 0 0" << std::endl;
         fc << "SfTopPt shape 1 1 1 1 0 0 0 0" << std::endl;
         fc << "Jes shape 1 1 1 1 0 0 0 0" << std::endl;
         fc << "Jer shape 1 1 1 1 0 0 0 0" << std::endl;
        /*
