	...
	for(int ic=0;ic<nc;ic++)
	  {
        ...
        */
         ...
         float statsTtbbcclf = h_ttbbttccttlf->Integral();
         TH1F* h_ttbbttcc = (TH1F*)f->Get("h_ttbbttcc");
         float statsTtbbcc = h_ttbbttcc->Integral();
         TH1F* h_ttbbttlf = (TH1F*)f->Get("h_ttbbttlf");
         float statsTtbblf = h_ttbbttlf->Integral();
         TH1F* h_ttccttlf = (TH1F*)f->Get("h_ttccttlf");
         float statsTtcclf = h_ttccttlf->Integral();
         /*
