...
#OPTIONS="$OPTIONS --rMin=0.0 --rMax=50.0"
#OPTIONS="$OPTIONS --rMin=0.0 --rMax=1000.0"
#OPTIONS="$OPTIONS --rMin=0.0 --rMax=20.0"
#OPTIONS="$OPTIONS --rMin=0.0 --rMax=10.0"
#OPTIONS="$OPTIONS --rMin=0.0 --rMax=6.0"
OPTIONS="$OPTIONS --rMin=0.0 --rMax=2.0"
