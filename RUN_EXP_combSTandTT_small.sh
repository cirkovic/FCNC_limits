...
OUTPUT=~/www/04-03-2017_log/TrainingsWithTightEID_NEW_EXP_${CASE}/${N}
OUTPUT=~/www/15-03-2017/TrainingsWithTightEID_NEW_EXP_${CASE}/${N}
OUTPUT=~/www/21-03-2017/limits/TrainingsWithTightEID_NEW_EXP_${CASE}/${N}
OUTPUT=~/www/22-03-2017/limits/TrainingsWithTightEID_NEW_EXP_${CASE}/${N}
OUTPUT=${OUTDIR}/TrainingsWithTightEID_NEW_EXP_${CASE}/${N}
...
./COMBINE_NEW_EXP_small.sh ${N} ${S} ${CASE}
python parse_combine_output_${N}.py COMBINE_OUTPUT_${N}.txt
cd limits
if [[ "${N}" == "combSTandTT" ]]; then
./runShow_small.sh $OUTPUT 1.0 1.0
fi
cd plot
./runShow_small.sh $OUTPUT
cd ../..
