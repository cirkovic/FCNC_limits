...
out1='~/www/17-02-2017_loose/abs/'
out2='~/www/17-02-2017_loose/rel/'

out1='~/www/18-02-2017_loose/abs/'
out2='~/www/18-02-2017_loose/rel/'
...
for k in ['u', 'c']:
    for c in ['b2j3', 'b3j3', 'b2j4', 'b3j4', 'b4j4']:
        ...
        fn = 'input_loose/input_MVAH'+k+'tMAX_'+c+'_h'+k+'t.root'
        #print fn
