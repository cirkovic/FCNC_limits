...
#OPTIONS="$OPTIONS --rMin=0.0 --rMax=10.0"
#OPTIONS="$OPTIONS --rMin=-50.0 --rMax=50.0"
#OPTIONS="$OPTIONS --rMin=-500.0 --rMax=500.0"
#OPTIONS="$OPTIONS --rMin=-10.0 --rMax=10.0"
#OPTIONS="$OPTIONS --rMin=-5.0 --rMax=5.0"
#OPTIONS="$OPTIONS --rMin=-3.0 --rMax=3.0"
OPTIONS="$OPTIONS --rMin=-1.0 --rMax=1.0"
# OPTIONS="$OPTIONS --signalPdfNames=combSTandTT_sig_*"
# OPTIONS="$OPTIONS --backgroundPdfNames=combSTandTT_ttbb_*,combSTandTT_ttcc_*,combSTandTT_ttlf_*,combSTandTT_other_*"
# OPTIONS="$OPTIONS --protectUnbinnedChannels"
# OPTIONS="$OPTIONS --autoMaxPOIs"
# OPTIONS="$OPTIONS --autoBoundsPOIs"
# OPTIONS="$OPTIONS --preFitValue=0.0"
...
# _1 OPTIONS="$OPTIONS --minimizerAlgo=SeqMinimizer --rMin -5 --rMax 5 --robustFit=1 --stepSize=0.05 --minimizerTolerance 0.01" # THIS IS THE ONE FROM THE NOTE
...
# _3 OPTIONS="$OPTIONS --minimizerAlgo=SeqMinimizer --rMin 0 --rMax 10 --robustFit=1 --stepSize=0.02 --minimizerTolerance 0.005" # RETURN TO THIS ONE
# _4 OPTIONS="$OPTIONS --rMin=0 --rMax=10 --stepSize=0.05 --minimizerAlgo=SeqMinimizer --minimizerAlgoForMinos=SeqMinimizer --minimizerToleranceForMinos 0.001 --minos=all"

# _2 OPTIONS="$OPTIONS --minimizerAlgo=SeqMinimizer --robustFit=1 --stepSize=0.05 --minimizerTolerance 0.01" # RETURN TO THIS ONE
