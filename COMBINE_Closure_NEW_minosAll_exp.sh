...
for j in `ls cards`; do
    ...
    COMMAND="combine -S ${S} -M MaxLikelihoodFit -t -1 --expectSignal 0.01 ../cards/${i} -n _001 --minos=all && python /afs/cern.ch/work/c/cirkovic/kLimits/CombineHarvester/CMSSW_7_4_7/src/HiggsAnalysis/CombinedLimit/test/diffNuisances.py -a mlfit_001.root -g plots_001.root"
