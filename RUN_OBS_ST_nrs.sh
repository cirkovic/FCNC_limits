...
cp -f produce_cards/TrainingsWithTightEID_NEW_${CASE}_${N}_1_ttAdd_nrs/produceCards_ST.C produceCards.C
./produceCards.zsh
cd cards
...
./COMBINE_OBS_ST_nrs.sh ${N} ${S} ${CASE}
...
./runShow_wohutb4j4_obs_nrs.sh $OUTPUT 30.0 600.0 true
fi
cd plot
...
./runShow_small_2_obs_nrs.sh $OUTPUT 1000.0 0.1 1000.0 0.1 1
cd ../..
