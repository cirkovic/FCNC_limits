...
OUTPUT=~/www/07-08-2017/WithStatUnc_mscan_positiveOnly
OUTPUT=~/www/08-08-2017/WithStatUnc_mscan_positiveOnly
...
#    for j in hdamp_UE_Jes_SfIterativeFit; do
    ...
    ./RUN_pulls_unblinded_WithStatUnc_mscan_07-08-2017_positiveOnly.sh ${OUTPUT} ${i}
done
