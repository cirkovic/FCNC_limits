...
/*	     fc << "bin " << cat[ic] << " " << cat[ic] << std::endl;
         ...
         */
         fc << "SfIterativeFitHfstats1 shape 1 1 1" << std::endl;
         fc << "SfIterativeFitHfstats2 shape 1 1 1" << std::endl;
         fc << "SfIterativeFitLfstats1 shape 1 1 1" << std::endl;
         fc << "SfIterativeFitLfstats2 shape 1 1 1" << std::endl;
         fc << "SfIterativeFitJes      shape 1 1 1" << std::endl;
         fc << "SfIterativeFitLf       shape 1 1 1" << std::endl;
         fc << "SfIterativeFitHf       shape 1 1 1" << std::endl;
         fc << "SfIterativeFitCferr1   shape 1 1 1" << std::endl;
         fc << "SfIterativeFitCferr2   shape 1 1 1" << std::endl;
         fc << "Jes                    shape 1 1 1" << std::endl;
         fc << "Jer                    shape 1 1 1" << std::endl;
        /*
