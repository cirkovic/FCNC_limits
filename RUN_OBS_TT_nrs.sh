...
cp -f produce_cards/TrainingsWithTightEID_NEW_${CASE}_${N}_1_ttAdd_nrs/produceCards_TT.C produceCards.C
./produceCards.zsh
cd cards
...
./COMBINE_OBS_TT_nrs.sh ${N} ${S} ${CASE}
...
./runShow_wohutb4j4_obs_nrs.sh $OUTPUT 30.0 30.0 true
fi
cd plot
