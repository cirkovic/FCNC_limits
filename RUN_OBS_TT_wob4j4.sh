...
OUTPUT=~/www/25-03-2017_STTT/TrainingsWithTightEID_NEW_OBS_${CASE}_wob4j4/TT
OUTPUT=${1}/TrainingsWithTightEID_NEW_OBS_${CASE}_wob4j4/TT
...
./COMBINE_NEW_OBS_5_small_TT_1.sh ${N} ${S} ${CASE}
