...
//void limitXsecCat()
void limitXsecCatShowWob4j4_small_obs_STTT(std::string coup = "Hut", std::string sttt = "ST", double ymin = 0.0, double ymax = 200., bool show = true)
{
   gROOT->SetBatch(1);
   ...
   //std::string coup = "Hct";
   //float xsec = 50.82;
   float xsec = 50.82/10; if (sttt == "ST") xsec = 13.84/10; else xsec = 36.98/10;
   //float xsec = 1.0;
   //float xsec = 1.0;
   //if( coup == "Hct" ) xsec = 38.88;
   if( coup == "Hct" ) { xsec = 38.88/10; if (sttt == "ST") xsec = 1.90/10; else xsec = 36.98/10; }
...
//   tex2->Draw();
   ...
   for (int i = 0; i < nChan; i++) {
       ...
       limLab << " (" << hLimitXsecObs_bkp[i]->GetBinContent(i+1) << ")";
