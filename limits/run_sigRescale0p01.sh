...
#root -l "limitXsecCat.C(\"Hut\", 0, 30)" #&& display pics/LimitComp_Hut_1.eps &
root -l "limitXsecCat_sigRescale0p01.C(\"Hut\", 0, ${M1})" #&& display pics/LimitComp_Hut_1.eps &
...
root -l "limitXsecCat_sigRescale0p01.C(\"Hct\", 0, ${M2})" #&& display pics/LimitComp_Hct_1.eps #&
