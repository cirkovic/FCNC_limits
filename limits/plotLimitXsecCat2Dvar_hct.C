...
//void limitXsecCat()
void plotLimitXsecCat2Dvar_hct(std::string coup = "2D", std::string name = "combSTandTT", std::string type = "all", float max = 0.2, int nChan = 50, float limit = 1.0)
{
   gROOT->SetBatch(1);
   ...
   for (int y = 0; y < nChan; y++) {
      for (int x = 0; x < nChan; x++) {
         ...
         */
         ...
         if (name == "ST") {
             if (type == "med")
                 h2->SetBinContent(x+1, y+1, med[y][x]*(1.90/10));
             else if (type == "s1p")
                 h2->SetBinContent(x+1, y+1, s1p[y][x]*(1.90/10));
             else if (type == "s1m")
                 h2->SetBinContent(x+1, y+1, s1m[y][x]*(1.90/10));
             else if (type == "obs")
                 h2->SetBinContent(x+1, y+1, obs[y][x]*(1.90/10));
             else if (type == "all")
                 h2->SetBinContent(x+1, y+1, 0.0);
         }
         else if (name == "TT") {
             ...
             if (type == "med")
                 h2->SetBinContent(x+1, y+1, med[y][x]*(1.90/10+36.98/10));
             else if (type == "s1p")
                 h2->SetBinContent(x+1, y+1, s1p[y][x]*(1.90/10+36.98/10));
             else if (type == "s1m")
                 h2->SetBinContent(x+1, y+1, s1m[y][x]*(1.90/10+36.98/10));
             else if (type == "obs")
                 h2->SetBinContent(x+1, y+1, obs[y][x]*(1.90/10+36.98/10));
             else if (type == "all")
                 h2->SetBinContent(x+1, y+1, 0.0);
         }
         */
         if (name == "ST") {
             if (type == "med")
                 h2->SetBinContent(x+1, y+1, med[y][x]*(1.90*pow(0.01*x, 2)));
             else if (type == "s1p")
                 h2->SetBinContent(x+1, y+1, s1p[y][x]*(1.90*pow(0.01*x, 2)));
             else if (type == "s1m")
                 h2->SetBinContent(x+1, y+1, s1m[y][x]*(1.90*pow(0.01*x, 2)));
             else if (type == "obs")
                 h2->SetBinContent(x+1, y+1, obs[y][x]*(1.90*pow(0.01*x, 2)));
             else if (type == "all")
                 h2->SetBinContent(x+1, y+1, 0.0);
         }
         else if (name == "TT") {
             if (type == "med")
                 h2->SetBinContent(x+1, y+1, med[y][x]*(36.98*pow(0.01*y, 2)));
             else if (type == "s1p")
                 h2->SetBinContent(x+1, y+1, s1p[y][x]*(36.98*pow(0.01*y, 2)));
             else if (type == "s1m")
                 h2->SetBinContent(x+1, y+1, s1m[y][x]*(36.98*pow(0.01*y, 2)));
             else if (type == "obs")
                 h2->SetBinContent(x+1, y+1, obs[y][x]*(36.98*pow(0.01*y, 2)));
             else if (type == "all")
                 h2->SetBinContent(x+1, y+1, 0.0);
         }
         else {
             if (type == "med")
                 h2->SetBinContent(x+1, y+1, med[y][x]*(1.90*pow(0.01*x, 2)+36.98*pow(0.01*y, 2)));
             else if (type == "s1p")
                 h2->SetBinContent(x+1, y+1, s1p[y][x]*(1.90*pow(0.01*x, 2)+36.98*pow(0.01*y, 2)));
             else if (type == "s1m")
                 h2->SetBinContent(x+1, y+1, s1m[y][x]*(1.90*pow(0.01*x, 2)+36.98*pow(0.01*y, 2)));
             else if (type == "obs")
                 h2->SetBinContent(x+1, y+1, obs[y][x]*(1.90*pow(0.01*x, 2)+36.98*pow(0.01*y, 2)));
             else if (type == "all")
                 h2->SetBinContent(x+1, y+1, 0.0);
         }
         /*
         if (name == "ST") {
             if (type == "med")
                 h2->SetBinContent(x+1, y+1, med[y][x]*(1.90/10*pow(0.01*x, 2)));
             else if (type == "s1p")
                 h2->SetBinContent(x+1, y+1, s1p[y][x]*(1.90/10*pow(0.01*x, 2)));
             else if (type == "s1m")
                 h2->SetBinContent(x+1, y+1, s1m[y][x]*(1.90/10*pow(0.01*x, 2)));
             else if (type == "obs")
                 h2->SetBinContent(x+1, y+1, obs[y][x]*(1.90/10*pow(0.01*x, 2)));
             else if (type == "all")
                 h2->SetBinContent(x+1, y+1, 0.0);
         }
         else if (name == "TT") {
             if (type == "med")
                 h2->SetBinContent(x+1, y+1, med[y][x]*(36.98/10*pow(0.01*y, 2)));
             else if (type == "s1p")
                 h2->SetBinContent(x+1, y+1, s1p[y][x]*(36.98/10*pow(0.01*y, 2)));
             else if (type == "s1m")
                 h2->SetBinContent(x+1, y+1, s1m[y][x]*(36.98/10*pow(0.01*y, 2)));
             else if (type == "obs")
                 h2->SetBinContent(x+1, y+1, obs[y][x]*(36.98/10*pow(0.01*y, 2)));
             else if (type == "all")
                 h2->SetBinContent(x+1, y+1, 0.0);
         }
         else {
             if (type == "med")
                 h2->SetBinContent(x+1, y+1, med[y][x]*(1.90/10*pow(0.01*x, 2)+36.98/10*pow(0.01*y, 2)));
             else if (type == "s1p")
                 h2->SetBinContent(x+1, y+1, s1p[y][x]*(1.90/10*pow(0.01*x, 2)+36.98/10*pow(0.01*y, 2)));
             else if (type == "s1m")
                 h2->SetBinContent(x+1, y+1, s1m[y][x]*(1.90/10*pow(0.01*x, 2)+36.98/10*pow(0.01*y, 2)));
             else if (type == "obs")
                 h2->SetBinContent(x+1, y+1, obs[y][x]*(1.90/10*pow(0.01*x, 2)+36.98/10*pow(0.01*y, 2)));
             else if (type == "all")
                 h2->SetBinContent(x+1, y+1, 0.0);
         }
         */
...
//   TF2 *f2 = new TF2("f2", "[0]+[1]*(x**2)+[2]*(y**2) + [3]+[4]*(x**2)+[5]*(y**2)", 0.0, 0.2, 0.0, 0.2);
   ...
   TF2 *f2 = new TF2("f2", "[0]+[1]*atan(([2]*y)/([3]*x))", 0.0, 0.5, 0.0, 0.5);
   f2->SetParameters(1.0, 1.0, 1.0, 1.0);
   ...
   if (type == std::string("all")) {
       ...
       for (int xi = 0; xi < h2->GetXaxis()->GetNbins(); xi++) {
           for (int yi = 0; yi < h2->GetXaxis()->GetNbins(); yi++) {
               if (h2->GetBinContent(xi+1, yi+1) < (1+delta) && h2->GetBinContent(xi+1, yi+1) > (1-delta)) {
//                    h2->SetBinContent(xi+1, yi+1, 0.0);
               }
           }
       }
       /*
