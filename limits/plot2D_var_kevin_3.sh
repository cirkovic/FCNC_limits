...
#root -l -b -q "plotLimitXsecCat2Dvar_kevin_3.C(\"2D\", \"${name}\", \"ALL\", ${M}, ${N}, 1.0)" #&& display pics/LimitComp_Hut_2.eps &
if [[ "0" == "1" ]]; then
root -l -b -q "plotLimitXsecCat2Dvar_kevin_ALL_3.C(\"2D\", \"${name}\", \"ALL\", ${M}, ${N}, 1.0)" #&& display pics/LimitComp_Hut_2.eps &
...
root -l -b -q "plotLimitXsecCat2Dvar_kevin_3.C(\"2D\", \"${name}\", \"med\", ${M}, ${N}, 1.0)" #&& display pics/LimitComp_Hut_2.eps &

cp pics/LimitComb2D.png $OUTPUT/LimitComb2D_med.png
cp pics/LimitComb2D.pdf $OUTPUT/LimitComb2D_med.pdf

root -l -b -q "plotLimitXsecCat2Dvar_kevin_3.C(\"2D\", \"${name}\", \"s1m\", ${M}, ${N}, 1.0)" #&& display pics/LimitComp_Hut_2.eps &

cp pics/LimitComb2D.png $OUTPUT/LimitComb2D_s1m.png
cp pics/LimitComb2D.pdf $OUTPUT/LimitComb2D_s1m.pdf

root -l -b -q "plotLimitXsecCat2Dvar_kevin_3.C(\"2D\", \"${name}\", \"s1p\", ${M}, ${N}, 1.0)" #&& display pics/LimitComp_Hut_2.eps &

cp pics/LimitComb2D.png $OUTPUT/LimitComb2D_s1p.png
cp pics/LimitComb2D.pdf $OUTPUT/LimitComb2D_s1p.pdf

root -l -b -q "plotLimitXsecCat2Dvar_kevin_3.C(\"2D\", \"${name}\", \"s2m\", ${M}, ${N}, 1.0)" #&& display pics/LimitComp_Hut_2.eps &

cp pics/LimitComb2D.png $OUTPUT/LimitComb2D_s2m.png
cp pics/LimitComb2D.pdf $OUTPUT/LimitComb2D_s2m.pdf

root -l -b -q "plotLimitXsecCat2Dvar_kevin_3.C(\"2D\", \"${name}\", \"s2p\", ${M}, ${N}, 1.0)" #&& display pics/LimitComp_Hut_2.eps &

cp pics/LimitComb2D.png $OUTPUT/LimitComb2D_s2p.png
cp pics/LimitComb2D.pdf $OUTPUT/LimitComb2D_s2p.pdf

root -l -b -q "plotLimitXsecCat2Dvar_kevin_3.C(\"2D\", \"${name}\", \"obs\", ${M}, ${N}, 1.0)" #&& display pics/LimitComp_Hut_2.eps &
