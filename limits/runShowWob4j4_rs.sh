...
#root -l "limitXsecCat.C(\"Hut\", 0, 30)" #&& display pics/LimitComp_Hut_1.eps &
root -l "limitXsecCatShowWob4j4_rs.C(\"Hut\", 0, ${M1})" #&& display pics/LimitComp_Hut_1.eps &
...
root -l "limitXsecCatShowWob4j4_rs.C(\"Hct\", 0, ${M2})" #&& display pics/LimitComp_Hct_1.eps #&
