...
void plotLimitXsecCat2Dvar_kevin_ALL_2(std::string coup = "2D", std::string name = "combSTandTT", std::string type = "ALL", float max = 0.2, int nChan = 50, float limit = 1.0)
{
   gROOT->SetBatch(1);
...
//       h2_obs->Fit("f2_obs");
   ...
   */
   ...
   if (type == "ALL") {
       ...
       f2_s1m->SetLineStyle(2);
       f2_s1p->SetLineStyle(2);
       f2_s2m->SetLineStyle(1);
       f2_s2p->SetLineStyle(1);
       f2_obs->SetLineStyle(2);
       */
