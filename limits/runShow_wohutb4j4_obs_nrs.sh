...
root -l "limitXsecCatShowWob4j4_small_obs_nrs.C(\"Hut\", 0, ${M1}, ${show})" #&& display pics/LimitComp_Hut_1.eps &
...
root -l "limitXsecCatShow_small_obs_nrs.C(\"Hct\", 0, ${M2}, ${show})" #&& display pics/LimitComp_Hct_1.eps #&
