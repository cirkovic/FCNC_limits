...
root -l "limitXsecCatShowWob4j4_small_01.C(\"Hut\", 0, ${M1})" #&& display pics/LimitComp_Hut_1.eps &
...
root -l "limitXsecCatShow_small_01.C(\"Hct\", 0, ${M2})" #&& display pics/LimitComp_Hct_1.eps #&
