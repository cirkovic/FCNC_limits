...
rm pics/*
rm limitNums_Hut.txt limitNums_Hct.txt
#PS=""
...
#root -l "limitXsecCatShowWob4j4_small_obs.C(\"Hut\", 0, ${M1}, ${show})" #&& display pics/LimitComp_Hut_1.eps &
#root -l "limitXsecCatShowWob4j4_small_obs_27072017.C(\"Hut\", 0, ${M1}, ${show})" #&& display pics/LimitComp_Hut_1.eps &
root -l "limitXsecCatShowWob4j4_small_obs_07082017.C(\"Hut\", 0, ${M1}, ${show})" #&& display pics/LimitComp_Hut_1.eps &
...
#root -l "limitXsecCatShow_small_obs.C(\"Hct\", 0, ${M2}, ${show})" #&& display pics/LimitComp_Hct_1.eps #&
#root -l "limitXsecCatShow_small_obs_27072017.C(\"Hct\", 0, ${M2}, ${show})" #&& display pics/LimitComp_Hct_1.eps #&
root -l "limitXsecCatShow_small_obs_07082017.C(\"Hct\", 0, ${M2}, ${show})" #&& display pics/LimitComp_Hct_1.eps #&
