...
//void limitXsecCat()
void limitXsecCatShowWob4j4_small_obs_07082017(std::string coup = "Hut", double ymin = 0.0, double ymax = 200., int show = 0)
{
   gROOT->SetBatch(1);
   ...
   //float xsec = 50.82;
   //float xsec = 50.82/10;
   float xsec = 50.82/13.6;
   //float xsec = 691.152;
   //float xsec = 1.0;
   //float xsec = 1.0;
   //if( coup == "Hct" ) xsec = 38.88;
   //if( coup == "Hct" ) xsec = 38.88/10;
   if( coup == "Hct" ) xsec = 38.88/13.6;
   //if( coup == "Hct" ) xsec = 528.768;
...
//   tex2->Draw();
   ...
   std::ofstream myfile;
   myfile.open((std::string("limitNums_")+coup+"_"+to_string(show)+std::string(".txt")).c_str());
   std::string limLine;
