...
void plotLimitXsecCat2Dvar_kevin_ALL_1(std::string coup = "2D", std::string name = "combSTandTT", std::string type = "ALL", float max = 0.2, int nChan = 50, float limit = 1.0)
{
   gROOT->SetBatch(1);
   ...
   */
   ...
   double *paramsa[] = {params, params_s1m, params_s1p, params_obs};
   //double params[] = {1,0, 1.1, 0.0, 0.9, 0.0};
   TF2 *fta[] = {f2, f2_s1m, f2_s1p, f2_obs}, *f2t;
   TH2F *hta[] = {h2, h2_s1m, h2_s1p, h2_obs}, *h2t;
