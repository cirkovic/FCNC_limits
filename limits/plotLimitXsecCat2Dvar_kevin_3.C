...
//void limitXsecCat()
void plotLimitXsecCat2Dvar_kevin_3(std::string coup = "2D", std::string name = "combSTandTT", std::string type = "all", float max = 0.2, int nChan = 50, float limit = 1.0)
{
   gROOT->SetBatch(1);
...
//   TF2 *f2 = new TF2("f2", "[0]+[1]*(x**2)+[2]*(y**2) + [3]+[4]*(x**2)+[5]*(y**2)", 0.0, 0.2, 0.0, 0.2);
   ...
   */
   ...
   double *cx, *cx1, *cx2, *cx3, *cx4, *cx5, *cx6;
   double *cy, *cy1, *cy2, *cy3, *cy4, *cy5, *cy6;
   ...
   cx5 = new double[h2->GetXaxis()->GetNbins()];
   cy5 = new double[h2->GetYaxis()->GetNbins()];
   cx6 = new double[h2->GetXaxis()->GetNbins()];
   cy6 = new double[h2->GetYaxis()->GetNbins()];
   /*
   ...
   cx5 = new double[Nxymax];
   cy5 = new double[Nxymax];
   cx4 = new double[Nxymax];
   cy4 = new double[Nxymax];
   */
   int ic = 0, n1 = 0, nc1, nc2, nc3;
   /*
   int ic1 = 0, nc1 = 0;
   int ic2 = 0, nc2 = 0;
   int ic3 = 0, nc3 = 0;
   ...
   */
   ...
   if (type == std::string("all")) {
       ...
       iss.str(""); iss.clear(); iss << cline;
       std::cout << iss.str() << std::endl;
       while (iss >> number) cx5[ic3++] = number;

       myfile.getline(cline, 1024);
       iss.str(""); iss.clear(); iss << cline;
       std::cout << iss.str() << std::endl;
       while (iss >> number) cy5[nc3++] = number;
       ...
       */
       ...
       int *XI1 = new int[h2->GetXaxis()->GetNbins()];
       int *YI1 = new int[h2->GetYaxis()->GetNbins()];
       int *XI2 = new int[h2->GetXaxis()->GetNbins()];
       int *YI2 = new int[h2->GetYaxis()->GetNbins()];
       int *XI3 = new int[h2->GetXaxis()->GetNbins()];
       int *YI3 = new int[h2->GetYaxis()->GetNbins()];
       int *XI4 = new int[h2->GetXaxis()->GetNbins()];
       int *YI4 = new int[h2->GetYaxis()->GetNbins()];
       ...
       for (int xi = 0; xi < h2->GetXaxis()->GetNbins(); xi++){
           ...
           if (xi == 0)
               ...
               ystart = 0;
           YI1[xi] = ystart;
           for (int yi = ystart; yi < h2->GetYaxis()->GetNbins(); yi++){
              double d1 = h2->GetBinContent(xi+1, yi+1) - limit;
              double D1 = h2->GetBinContent(XI1[xi]+1, YI1[xi]+1) - limit;
              if (d1 > 0 && D1 > 0 && d1 < D1) {
                XI1[xi] = xi;
                YI1[xi] = yi;
              }
           }
           cx1[xi] = h2->GetXaxis()->GetBinCenter(XI1[xi]+1);
           cy1[xi] = h2->GetYaxis()->GetBinCenter(YI1[xi]+1);
       }
       ...
       for (int xi = 0; xi < h2->GetXaxis()->GetNbins(); xi++){
           ...
           if (xi == 0)
               ...
               ystop = 0;
           YI2[xi] = h2->GetYaxis()->GetNbins() - 1;
           for (int yi = h2->GetYaxis()->GetNbins() - 1; yi >= ystop; yi--){
              double d2 = limit - h2->GetBinContent(xi+1, yi+1);
              double D2 = limit - h2->GetBinContent(XI2[xi]+1, YI2[xi]+1);
              if (d2 > 0 && D2 > 0 && d2 < D2) {
                XI2[xi] = xi;
                YI2[xi] = yi;
              }
           }
           cx2[xi] = h2->GetXaxis()->GetBinCenter(XI2[xi]+1);
           cy2[xi] = h2->GetYaxis()->GetBinCenter(YI2[xi]+1);
       }
       ...
       for (int yi = 0; yi < h2->GetYaxis()->GetNbins(); yi++){
           ...
           if (yi == 0)
               ...
               xstart = 0;
           XI3[yi] = xstart;
           for (int xi = xstart; xi < h2->GetXaxis()->GetNbins(); xi++){
              double d3 = h2->GetBinContent(xi+1, yi+1) - limit;
              double D3 = h2->GetBinContent(XI3[yi]+1, YI3[yi]+1) - limit;
              if (d3 > 0 && D3 > 0 && d3 < D3) {
                XI3[yi] = xi;
                YI3[yi] = yi;
              }
           }
           cx3[yi] = h2->GetXaxis()->GetBinCenter(XI3[yi]+1);
           cy3[yi] = h2->GetYaxis()->GetBinCenter(YI3[yi]+1);
       }
       ...
       for (int yi = 0; yi < h2->GetYaxis()->GetNbins(); yi++){
           ...
           if (yi == 0)
               ...
               xstop = 0;
           XI4[yi] = h2->GetXaxis()->GetNbins() - 1;
           for (int xi = h2->GetXaxis()->GetNbins() - 1; xi >= xstop; xi--){
              double d2 = limit - h2->GetBinContent(xi+1, yi+1);
              double D2 = limit - h2->GetBinContent(XI4[yi]+1, YI4[yi]+1);
              if (d2 > 0 && D2 > 0 && d2 < D2) {
                XI4[yi] = xi;
                YI4[yi] = yi;
              }
           }
           cx4[yi] = h2->GetXaxis()->GetBinCenter(XI4[yi]+1);
           cy4[yi] = h2->GetYaxis()->GetBinCenter(YI4[yi]+1);
       }
       ...
       for (int xi = 0; xi < h2->GetXaxis()->GetNbins(); xi++){
           cx5[xi] = (cx1[xi] + cx2[xi]) / 2;
           if (cy2[xi] != cy1[xi])
               cy5[xi] = (cy2[xi] - cy1[xi])/(h2->GetBinContent(XI2[xi]+1, YI2[xi]+1) - h2->GetBinContent(XI1[xi]+1, YI1[xi]+1))*(1.0 -  h2->GetBinContent(XI1[xi]+1, YI1[xi]+1)) + cy1[xi];
           else
               cy5[xi] = (cy1[xi] + cy2[xi]) / 2;
       }
       ...
       for (int yi = 0; yi < h2->GetYaxis()->GetNbins(); yi++){
           cy6[yi] = (cy3[yi] + cy4[yi]) / 2;
           if (cx4[yi] != cx3[yi])
               cx6[yi] = (cx4[yi] - cx3[yi])/(h2->GetBinContent(XI4[yi]+1, YI4[yi]+1) - h2->GetBinContent(XI3[yi]+1, YI3[yi]+1))*(1.0 -  h2->GetBinContent(XI3[yi]+1, YI3[yi]+1)) + cx3[yi];
           else
               cx6[yi] = (cx3[yi] + cx4[yi]) / 2;
       }
...
//       cy[Nxi] = h2->GetYaxis()->GetBinCenter(1);
   ...
   //TGraph* gr1 = new TGraph(h2->GetXaxis()->GetNbins(), cx1, cy1);
   TGraph *gr1, *gr2, *gr3, *gr4, *gr5, *gr6;
   ...
   if (type == std::string("all")) {
       ...
       */
       ...
       //exit(0);
       for (ic = 0; ic < h2->GetXaxis()->GetNbins(); ic++) {
        if (cy1[ic] == h2->GetYaxis()->GetBinCenter(1)) break;
       }
       nc1 = ic+1;
       for (ic = 0; ic < h2->GetXaxis()->GetNbins(); ic++) {
        if (cy2[ic] == h2->GetYaxis()->GetBinCenter(1)) break;
       }
       nc2 = ic+1;
//       for (ic = 0; ic < h2->GetYaxis()->GetNbins(); ic++) {
//        if (cx3[ic] == h2->GetXaxis()->GetBinCenter(1)) break;
//       }
//       nc3 = ic+1;
//       for (ic = 0; ic < h2->GetYaxis()->GetNbins(); ic++) {
//        if (cx4[ic] == h2->GetXaxis()->GetBinCenter(1)) break;
//       }
//       nc4 = ic+1;
       nc5 = nc1; if (nc2 < nc5) nc5 = nc2;
//       nc6 = nc3; if (nc4 < nc6) nc6 = nc4;
       //nc1 = ic+1;
       //gr1 = new TGraph(nc1, cx1, cy1);
       //gr2 = new TGraph(nc2, cx2, cy2);
       //gr3 = new TGraph(nc3, cx5, cy5);
       ...
       //gr4 = new TGraph(nc4, cx4, cy4);
       gr5 = new TGraph(nc5, cx5, cy5);
       //gr6 = new TGraph(nc6, cx6, cy6);
       /*
       gr1 = new TGraph(h2->GetXaxis()->GetNbins(), cx1, cy1);
       gr2 = new TGraph(h2->GetXaxis()->GetNbins(), cx2, cy2);
       gr3 = new TGraph(h2->GetXaxis()->GetNbins(), cx5, cy5);
       */
   }
