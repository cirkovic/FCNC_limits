...
int main(int argc, const char *argv[])
{
   ...
   double xsecAtT = 38.88; if (sttt == "ST") xsecAtT = 1.90; else xsecAtT = 36.98;
   //double xsecAtT = 38.88*sqrt(0.1);
   //double xsecAtT = 1.0;
   //double xsecAt1 = 38.88;
   double xsecAt1 = 38.88/13.6; if (sttt == "ST") xsecAt1 = 1.90/13.6; else xsecAt1 = 36.98/13.6;
   //double xsecAt1 = 1.0;
   //double xsecAtT = 1.0;
   //double xsecAtT = 0.1;
//   double xsecAtT = 10.;
...
//   g_mel->GetXaxis()->SetTitle("#font[52]{#kappa_{Hct}}");
   ...
   */
   ...
   std::ofstream myfile;
   myfile.open((std::string("../limitNums_Hct")+"_"+std::to_string(DRAW_NUMS)+std::string(".txt")).c_str(), std::ofstream::out | std::ofstream::app);
   std::string limLine;
   limLine = std::string(" \\\\");
   ...
   limLab.str("");
   limLab << ((y2_p[0])/((DRAW_NUMS == 1)?(1/xsecAt1):1));
   ...
   limLab.str("");
   limLab << ((y1_p[0])/((DRAW_NUMS == 1)?(1/xsecAt1):1));
   ...
   limLab.str("");
   limLab << ((mel2[0])/((DRAW_NUMS == 1)?(1/xsecAt1):1));
   limLab << " & " << ((data2[0])/((DRAW_NUMS == 1)?(1/xsecAt1):1));
   ...
   limLab.str("");
   limLab << ((y1_n[0])/((DRAW_NUMS == 1)?(1/xsecAt1):1));
   ...
   limLab.str("");
   limLab << ((y2_n[0])/((DRAW_NUMS == 1)?(1/xsecAt1):1));
   ...
   limLab.str("");
   limLab << ((DRAW_NUMS == 1)?((intersect1)/xsecAt1):((intersect1)));
   limLab << " (" << ((DRAW_NUMS == 1)?((intersect2)/xsecAt1):(intersect2)) << ")";
   if (DRAW_NUMS == 1) lLimit.DrawLatex(0.45,0.30,limLab.str().c_str());
   else if (DRAW_NUMS == 2) lLimit.DrawLatex(0.45,0.30,limLab.str().c_str());
   ...
   limLab.str("");
   limLab << ((DRAW_NUMS == 1)?((0.1836*intersect1*intersect1/1.4)/xsecAt1):((0.1836*intersect1*intersect1/1.4)));
   limLab << " (" << ((DRAW_NUMS == 1)?((0.1836*intersect2*intersect2/1.4)/xsecAt1):((0.1836*intersect2*intersect2/1.4))) << ")";
   if (DRAW_NUMS == 1) lLimit.DrawLatex(0.45,0.25,limLab.str().c_str());
   else if (DRAW_NUMS == 2) lLimit.DrawLatex(0.45,0.25,limLab.str().c_str());
