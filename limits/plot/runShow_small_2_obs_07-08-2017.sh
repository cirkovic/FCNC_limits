...
#ln -sf plotHutShow_small_2_obs.cxx plot.cxx
ln -sf plotHutShow_small_2_obs_07082017.cxx plot.cxx
make clean
make
./plot ${2} ${3} ${6}
#display limit_Hut.png &

#ln -sf plotHctShow_small_2_obs.cxx plot.cxx
ln -sf plotHctShow_small_2_obs_07082017.cxx plot.cxx
make clean
make
./plot ${4} ${5} ${6}
