...
int main(int argc, const char *argv[])
{
   ...
   double xsecAt1 = 50.82/13.6; if (sttt == "ST") xsecAt1 = 13.84/13.6; else xsecAt1 = 36.98/13.6;
   //double xsecAt1 = 1.0;
   //double xsecAtT = 1.0;
   //double xsecAtT = 0.1;
//   double xsecAtT = 10.;
...
//   g_mel->GetXaxis()->SetTitle("#font[52]{#kappa_{Hct}}");
   ...
   */
   ...
   std::ofstream myfile;
   myfile.open((std::string("../limitNums_Hut")+"_"+std::to_string(DRAW_NUMS)+std::string(".txt")).c_str(), std::ofstream::out | std::ofstream::app);
   std::string limLine;
   limLine = std::string(" \\\\");
