...
./COMBINE_pulls_OBS_min_blind.sh ${N} ${S}
...
OUT=~/www/14-04-2017/pulls_blind
OUT=~/www/20-04-2017/pulls_blind
OUT=~/www/21-04-2017/pulls_blind
...
declare -A outputs=(
    ["backup_$DATE"]=combSTandTT_split_obs_min
)
