...
OUTPUT=${1}/1/TrainingsWithTightEID_OBS_${CASE}/${N}_${M}
...
#cp -f produce_cards/TrainingsWithTightEID_NEW_${CASE}_1_ttAdd_statBinUnc_corrected_StatUnc_2/produceCards_${N}.C produceCards.C
#cp -f produce_cards/TrainingsWithTightEID_NEW_${CASE}_${N}_1_ttAdd_statBinUnc_corrected_StatUnc_2_14-06-2017/produceCards_${N}.C produceCards.C
...
#cp -f produce_cards/TrainingsWithTightEID_NEW_${CASE}_combSTandTT_1_ttAdd_statBinUnc_corrected_StatUnc_2_21-06-2017/produceCards_${N}.C produceCards.C
#cp -f produce_cards/TrainingsWithTightEID_NEW_${CASE}_combSTandTT_1_ttAdd_statBinUnc_corrected_StatUnc_2_25-06-2017/produceCards_${N}.C produceCards.C
#cp -f produce_cards/TrainingsWithTightEID_NEW_${CASE}_combSTandTT_1_ttAdd_statBinUnc_corrected_StatUnc_2_28-06-2017/produceCards_${N}.C produceCards.C
cp -f produce_cards/TrainingsWithTightEID_NEW_${CASE}_combSTandTT_1_ttAdd_statBinUnc_corrected_StatUnc_2_29-06-2017/produceCards_${N}_${M}.C produceCards.C
#cp -f produce_cards/TrainingsWithTightEID_NEW_${CASE}_1_ttAdd_statBinUnc_corrected_StatUnc_2_woPDFEnvelope/produceCards_${N}.C produceCards.C
#cp -f produce_cards/TrainingsWithTightEID_NEW_${CASE}_${N}_1_ttAdd_statBinUnc_corrected/produceCards_${N}.C produceCards.C
./produceCards.zsh
cd cards
sh ../make_combos_${N}_new.sh
...
./COMBINE_pulls_OBS_unblinded_NEW_mscan.sh ${N} ${S}
...
declare -A outputs=(
    ["backup_$DATE"]=${N}_${M}_${CASE}_obs
)
