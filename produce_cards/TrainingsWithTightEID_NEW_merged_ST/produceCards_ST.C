	...
	for(int ic=0;ic<nc;ic++)
	  {
        ...
        */
         ...
         */
	     ...
	     //fc << "process sig_stop ttbbttccttlf other" << std::endl;
	     fc << "process sig_stop sig_ttbar ttbbttccttlf other" << std::endl;
	     ...
	     //fc << "rate "<< statsSigStop << " " << statsTtbbcclf << " " << statsOther << std::endl;
	     fc << "rate " << statsSigStop << " " << statsSigTtbar << " " << statsTtbbcclf << " " << statsOther << std::endl;
