...
void produceCards()
{
   ...
   std::string dist1[nd] = {"MVAHutST","MVAHctST"};
	...
	for(int ic=0;ic<nc;ic++)
	  {
        ...
        */
         ...
         std::string fhist = " /afs/cern.ch/work/c/cirkovic/FCNC_limits/merged_07-08-2017/"+fname+".root";
	     ...
	     fc << "process sig_stop ttbb ttcc ttlf other" << std::endl;
	     ...
	     fc << "rate " << statsSigStop << " " << statsTtbb << " " << statsTtcc << " " << statsTtlf << " " << statsOther << std::endl;
...
//         fc << "SfIteraviveFitCferr2 shape 1 1 1 1 1 1 1 1" << std::endl;
         ...
         */
             ...
             */
             double jesNum, scEnv;
             int jn;
             if      (string(coup[id]) == "hut" && cat[ic] == string("b2j3")) {jesNum = 1.01; scEnv = 1.15; jn = 3;}
             else if (string(coup[id]) == "hut" && cat[ic] == string("b2j4")) {jesNum = 1.05; scEnv = 1.15; jn = 4;}
             else if (string(coup[id]) == "hut" && cat[ic] == string("b3j3")) {jesNum = 1.01; scEnv = 1.15; jn = 3;}
             else if (string(coup[id]) == "hut" && cat[ic] == string("b3j4")) {jesNum = 1.05; scEnv = 1.15; jn = 4;}
             else if (string(coup[id]) == "hut" && cat[ic] == string("b4j4")) {jesNum = 1.05; scEnv = 1.20; jn = 4;}
             else if (string(coup[id]) == "hct" && cat[ic] == string("b2j3")) {jesNum = 1.01; scEnv = 1.15; jn = 3;}
             else if (string(coup[id]) == "hct" && cat[ic] == string("b2j4")) {jesNum = 1.05; scEnv = 1.15; jn = 4;}
             else if (string(coup[id]) == "hct" && cat[ic] == string("b3j3")) {jesNum = 1.01; scEnv = 1.15; jn = 3;}
             else if (string(coup[id]) == "hct" && cat[ic] == string("b3j4")) {jesNum = 1.05; scEnv = 1.15; jn = 4;}
             else if (string(coup[id]) == "hct" && cat[ic] == string("b4j4")) {jesNum = 1.05; scEnv = 1.20; jn = 4;}
             ...
             fc << "SfIteraviveFitCferr2 shape 1 1 1 1 1" << std::endl;
             fc << "Jer shape 1 1 1 1 1" << std::endl;
             fc << "tt_add_bbj" << jn << " lnN - 1.50 - - -" << std::endl;
             fc << "tt_add_ccj" << jn << " lnN - - 1.50 - -" << std::endl;

             const char *procs[] = {"sig_stop", "ttbb", "ttcc", "ttlf", "other"};
             const char *Procs[] = {"SigStop", "ttbb", "ttcc", "ttlf", "other"};
             int nprocs = 5;
