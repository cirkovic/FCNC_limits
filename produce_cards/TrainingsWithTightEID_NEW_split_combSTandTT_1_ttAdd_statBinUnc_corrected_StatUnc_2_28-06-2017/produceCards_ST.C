	...
	for(int ic=0;ic<nc;ic++)
	  {
        ...
        */
         ...
         std::string fhist = " /afs/cern.ch/user/k/kderoove/public/inputs_HLTEle32_ReducedVars_AcceptanceScale_Merge5Systs/"+fname+"_Mergedbackgrounds.root";
...
//         fc << "SfIteraviveFitCferr2 shape 1 1 1 1 1 1 1 1" << std::endl;
         ...
         */
             ...
             fc << "SystMerge shape 1 1 1 1 1" << std::endl;
