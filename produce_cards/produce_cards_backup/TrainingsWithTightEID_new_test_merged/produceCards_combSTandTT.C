	...
	for(int ic=0;ic<nc;ic++)
	  {
        ...
        */
         ...
         */
	     ...
	     fc << "process sig ttbbttccttlf" << std::endl;
	     ...
	     fc << "rate "<< statsSig << " " << statsTtbbcclf << std::endl;
...
//         fc << "SfIteraviveFitCferr2 shape 1 1 1 1 1 1" << std::endl;
         ...
         fc << "Jer shape 1 1 1 1 1 1" << std::endl;
         */
         //fc << "lumi lnN 1.026 1.055 1.1" << std::endl;
         fc << "lumi lnN 1.026 1.055" << std::endl;
         //fc << "SfIteraviveFitLf shape 1 1 1" << std::endl;
         //fc << "SfIteraviveFitHf shape 1 1 1" << std::endl;
         //fc << "SfIteraviveFitLfstats1 shape 1 1 1" << std::endl;
         //fc << "SfIteraviveFitLfstats2 shape 1 1 1" << std::endl;
         ...
         //fc << "Jes shape 1 1 1" << std::endl;
         //fc << "Jer shape 1 1 1" << std::endl;
         //fc << "MEPS shape 0 1 0" << std::endl;
         //fc << "UE shape 0 1 0" << std::endl;
         //fc << "scaleEnvelope shape 0 1 0" << std::endl;
        /*
