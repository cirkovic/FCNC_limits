...
//         fc << "SfIteraviveFitCferr2 shape 1 1 1 1 1 1 1 1" << std::endl;
         ...
         */
             //fc << "lumi lnN 1.01 - - - -" << std::endl;
             //fc << "lumi lnN 1.01 1.01 1.01 1.01 1.01" << std::endl;
             fc << "lumi_sig lnN 1.01 - - - -" << std::endl;
             fc << "lumi_bb lnN - 1.01 - - -" << std::endl;
             fc << "lumi_cc lnN - - 1.01 - -" << std::endl;
             fc << "lumi_lf lnN - - - 1.01 -" << std::endl;
             fc << "lumi_other lnN - - - - 1.01" << std::endl;
             //fc << "tt_norm lnN - 1.055 1.055 1.055 -" << std::endl;
             fc << "tt_norm_bb lnN - 1.055 - - -" << std::endl;
             fc << "tt_norm_cc lnN - - 1.055 - -" << std::endl;
             fc << "tt_norm_lf lnN - - - 1.055 -" << std::endl;
             //fc << "tt_additional lnN - 1.5 1.5 - -" << std::endl;
             fc << "tt_addbb lnN - 1.5 - - -" << std::endl;
             //fc << "tt_addbb lnN - 1.055 - - -" << std::endl;
             fc << "tt_addcc lnN - - 1.5 - -" << std::endl;
             //fc << "tt_addcc lnN - - 1.055 - -" << std::endl;
             fc << "other_norm lnN - - - - 1.1" << std::endl;
             fc << "SfIteraviveFitLf shape 1 1 1 1 1" << std::endl;
             fc << "SfIteraviveFitHf shape 1 1 1 1 1" << std::endl;
             fc << "SfIteraviveFitLfstats1 shape 1 1 1 1 1" << std::endl;
