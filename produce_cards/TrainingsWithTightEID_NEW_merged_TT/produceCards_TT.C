	...
	for(int ic=0;ic<nc;ic++)
	  {
        ...
        */
         ...
         */
	     ...
	     //fc << "process sig_ttbar ttbbttccttlf other" << std::endl;
	     fc << "process sig_ttbar sig_stop ttbbttccttlf other" << std::endl;
	     ...
	     //fc << "rate "<< statsSigTtbar << " " << statsTtbbcclf << " " << statsOther << std::endl;
	     fc << "rate " << statsSigTtbar << " " << statsSigStop << " " << statsTtbbcclf << " " << statsOther << std::endl;
...
//         fc << "SfIteraviveFitCferr2 shape 1 1 1 1 1 1" << std::endl;
         ...
         */
         ...
         fc << "Jes shape 1 1 1 1" << std::endl;
         fc << "Jer shape 1 1 1 1" << std::endl;
         fc << "MEPS shape 0 0 1 0" << std::endl;
         fc << "UE shape 0 0 1 0" << std::endl;
         fc << "scaleEnvelope shape 0 0 1 0" << std::endl;
        /*
