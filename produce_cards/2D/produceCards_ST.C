...
void produceCards(const char *fold, const char *subfold)
{
   gROOT->SetBatch(1);
   ...
   std::string dist[nd] = {"MVAHuctComb",};
   //std::string coup[nd] = {"hut","hct"};
   std::string coup[nd] = {"huct"};
	...
	for(int ic=0;ic<nc;ic++)
	  {
        ...
        */
	     ...
	     //std::string fhist = "/afs/cern.ch/work/c/cirkovic/TrainingsFCNC/input/"+fname+".root";
	     //std::string fhist = "/afs/cern.ch/work/c/cirkovic/TrainingsFCNC_2Dlimits/input/"+fname+"_Mergedbackgrounds.root";
	     //std::string fhist = "input/"+fname+"_Mergedbackgrounds.root";
	     //std::string fhist = "root://eoscms.cern.ch//eos/cms/store/caf/user/mdjordje/Cirkovic/FCNC/2Dlimits_1/"+std::string(fold)+"/"+fname+"_Mergedbackgrounds.root";
	     //std::string fhist = "root://eoscms.cern.ch//eos/cms/store/caf/user/mdjordje/Cirkovic/FCNC/2Dlimits_2/"+std::string(fold)+"/"+fname+"_Mergedbackgrounds.root";
	     //std::string fhist = "root://eoscms.cern.ch//eos/cms/store/caf/user/mdjordje/Cirkovic/rescaling2D_100_1/"+std::string(fold)+"/"+fname+"_Mergedbackgrounds.root";
	     //std::string fhist = "root://eoscms.cern.ch//eos/cms/store/caf/user/mdjordje/Cirkovic/rescaling2D_20_11-04-2017/"+std::string(fold)+"/"+fname+"_Mergedbackgrounds.root";
	     //std::string fhist = "root://eoscms.cern.ch//eos/cms/store/caf/user/mdjordje/Cirkovic/rescaling2D_20_11-04-2017/"+std::string(fold)+"/"+fname+"_Mergedbackgrounds.root";
	     //std::string fhist = "root://eoscms.cern.ch//eos/cms/store/caf/user/mdjordje/Cirkovic/rescaling2D_20_12-04-2017/"+std::string(fold)+"/"+fname+"_Mergedbackgrounds.root";
         //std::string fhist = "root://eoscms.cern.ch//eos/cms/store/caf/user/mdjordje/Cirkovic/rescaling2D_50_12-04-2017/"+std::string(fold)+"/"+fname+"_Mergedbackgrounds.root";
	     std::string fhist = std::string(fold)+"/"+std::string(subfold)+"/"+fname+"_Mergedbackgrounds.root";
