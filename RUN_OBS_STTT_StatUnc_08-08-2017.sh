...
#OUTDIR=${1}/STTT
OUTDIR=~/www/01-07-2017/STTT
OUTDIR=~/www/02-07-2017/STTT
OUTDIR=~/www/08-08-2017/STTT
OUTDIR=~/www/09-08-2017/STTT

#./RUN_OBS_ST_StatUnc_01-07-2017.sh ${OUTDIR}
./RUN_OBS_ST_StatUnc_08-08-2017.sh ${OUTDIR}

#./RUN_OBS_TT_StatUnc_01-07-2017.sh ${OUTDIR}
./RUN_OBS_TT_StatUnc_08-08-2017.sh ${OUTDIR}
